...
parser.add_argument('--hr_img_dir', type=str, default='/data2/users/jiahaolin/CATANet-main/whu/night/origin',
                    help='path to high resolution image dir')
parser.add_argument('--lr_img_dir', type=str, default='/data2/users/jiahaolin/CATANet-main/whu/night/result',
